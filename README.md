...
| lib-pay-core | 1.0.0 |
| lib-pay-wxpay | 1.0.0 |
| lib-pay-alipay | 1.0.1 |
| lib-pay-pingxx | 1.0.0 |
| lib-paylib-wxpay | 1.0.0 |
| lib-paylib-alipay | 1.0.0 |
...
lib-pay-alipay模块修复沙箱环境与正式环境切换问题，发布1.0.1。
...
dependencies {
	implementation 'cn.kevinwu:lib-pay-wxpay:1.0.0'//使用app原生微信支付时添加
   	implementation 'cn.kevinwu:lib-pay-alipay:1.0.1'//使用支付宝支付时添加
...
| paylib版本 | 官方版本 |
| ----------- | ----------- |
| 1.0.0 | wechat-sdk-android-with-mta:5.1.4 |
